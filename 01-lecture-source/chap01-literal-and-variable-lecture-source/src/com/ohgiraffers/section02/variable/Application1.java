...
public class Application1 {
    public static void main(String[] agrs){
        ...
        *   2. 한 번 저장해준 값을 재사용하기 위한 목적(변수를 이용하여 코드를 작성하면, 값을 변경할 때도 보다 간편하게 변경할 수 있다.
        ...
        * */
        ...
        sum = sum+10;
        System.out.println("sum에 또 10을 더하면 현재의 sum 값은? "+sum);

        sum = sum+10;
        System.out.println("sum에 10을 또 또 더하면 현재의 sum 값은? "+sum);
