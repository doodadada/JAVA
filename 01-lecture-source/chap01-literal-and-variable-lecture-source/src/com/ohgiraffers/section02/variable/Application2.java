...
public class Application2 {
    public static void main(String[] args) {
        ...
        *   int inum = 1; <<<변수 선언 및 초기화 */
        ...
        /*  문자를 취급하는 자료형에는 1가지가 있다.*/
        char ch; //2byte
        char ch2;

        /*  목차 1-1-3. 논리값을 취급하는 자료형 */
        /*  논리값를 취급하는 자료형에는 1가지가 있다.*/
        ...
        lnum = 8L; // -9223342036854775808 ~ 922337203685477587
        // lnum - 아무 문제 없을 것 같지만 뒤에 대문자 L을 붙여야합니다. 그이유는 형변환에서 알려드립니다~

        /*  목차 2-2. 실수를 취급하는 자료형에 값 대입*/
        fnum = 4.0f; //float은 입력 후 뒤에 f을 붙여야합니다. (필수)
        dnum = 3.14; //double은 입력 후 뒤에 d를 붙여도 되는데 보통 안붙임

        /*  목차 2-3. 문자를 취급하는 자료형에 값 대입*/

        ch = 'a'; //문자 형태의 값을 저장할 수 있다.
        ch2 = 97; //'a'는 '97'숫자엿지? 그래서 숫자로도 저장할 수 있다.

        System.out.println("ch와 ch2를 비교하면 " + (ch==ch2) + "같은 값으로 인식한다.");

        /*  목차 2-4. 논리를 취급하는 자료형에 값 대입*/
        isTrue = true;
        isTrue = false;

        /*  목차 2-5. 문자열를 취급하는 자료형에 값 대입*/
        str = "안녕하세요";
