...
public class Application3 {
    public static void main(String[] args){
        ...
        * */
        ...
        /*  목차 1. 두수의 연산 결과를 int형으로 변환 후 int 자료형 변수에 리턴받는다.*/

        int isum1 = (int)(inum+lnum); //1번 //괄호 안 덧셈에서

        /*  목차 2. long형 값을 int로 강제 형변환한다.*/
        int isum2 = inum+(int)lnum; //2번


        /*  목차 3. 결과값을 long으로 받는다.(자동형변환 이용) */

        long lsum3 = inum+lnum; //1번
