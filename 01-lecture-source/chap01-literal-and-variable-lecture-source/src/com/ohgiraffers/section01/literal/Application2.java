...
public class Application2 {
    public static void main(String[] args) {
        ...
        System.out.println(123 / 10);
        System.out.println(123 & 10); //몫 구하는
        System.out.println(123 % 10);

        /*  1-2. 실수와 실수의 연산 */
        /*  실수끼리의 연산도 수학에서 사용하는 사칙연산에 추가로 나머지를 구하는 연산을 사용할 수 있다. */
        ...
        /*  2. 문자의 연산 */
        /*  2-1. 문자와 문자의 연산 */
        /*  문자끼리의 연산도 사칙 연산에 나머지를 구하는 연산을 사용할 수 있다 */
        ...
        /*  2-2. 문자와 정수의 연산 */
        /*  문자에 정수를 연산하는 것도 사칙 연산에 나머지를 구하는 연산을 사용할 수 있다 */
        /*
        ...
        /*  2-3. 문자와 실수의 연산 */
        /*  실수도 숫자이기에 정수의 연산처럼 사칙 연산에 나머지를 구하는 연산을 사용할 수 있다 */
        /*  단, 모든 결과는 실수의 형태로 나오게 된다. */
...
//        System.out.println("hello"%"world"); 에러발생
        ...
        /*  3-2-2. 문자열과 실수의 연산*/
        System.out.println("helloworld" + 3.14159247);
        /*  3-2-3. 문자열과 문자의 연산*/
...
//        System.out.println(true % 0.1); 에러발생
        ...
        /*  이유는 문자는 컴퓨터에서 숫자로 인식하기 때문에 결국 논리값과 숫자의 연산과 동일하다.*/
...
//        System.out.println(true % 'a'); 에러발생
        ...
        System.out.println(true + "a"); //문자열 합치기
        //System.out.println(true - "a"); //문자열 합치기 에러발생
        //System.out.println(true * "a"); //문자열 합치기 에러발생
        //System.out.println(true / "a"); //문자열 합치기 에러발생
        //System.out.println(true % "a"); //문자열 합치기 에러발생
