...
public class C_ifElseIf {
    public void simepleIfElseIfstatement() {
         ...
         *  }
         * */
        System.out.println("산 속의 나무를 하던 나무꾼이 연못에 도끼를 빠트리고 말았다.");
        ...
        if (answer == 1) {
            System.out.println("이런 거짓말쟁이!! 너에게는 아무런 도끼도 줄 수 없다!! 욕심쟁이야!!");
        } else if (answer == 2) {
            System.out.println("욕심이 과하지는 않지만 그래도 넌 거짓말을 하고 있구나!! 어서 썩 사라지거라!!");
        } else {
            System.out.println("착한 너에게 금도끼와 은도끼까지 모두 주마");
        }
        System.out.println("이야기 끝.");
    }
