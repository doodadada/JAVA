...
public class Application4 {
    public static void main(String[] args) {
        ...
        /*
        *  Stack 메모리 구조는 선행 메모리공간에 데이터를 저장하며
        ...
        * */
        ...
        System.out.println("integerStack.pop() = " + integerStack.pop());
        System.out.println("integerStack.pop() = " + integerStack.pop());
        //System.out.println("integerStack.pop() = " + integerStack.pop()); //에러발생, EmptyStackException
        System.out.println("integerStack = " + integerStack);
