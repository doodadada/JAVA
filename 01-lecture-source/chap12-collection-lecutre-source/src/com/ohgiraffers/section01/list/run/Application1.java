...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 지정된 위치의 값을 수정할 때에도 인덱스르 활용할 수 있으며 set()메소드를 사용한다.*/
        arrayList.set(1, Boolean.valueOf(true));
        System.out.println("arrayList = " + arrayList);

        /* 모든 컬렉션 프레임 워크 클래스는 제네릭 클래스로 작성되어 있다.*/
        ...
        /* Collection인터페이스가 아니고 Colections클래스이고 static 메소드이다.
        ...
        *  반복자라고 불리우며, 반복문을 이용해서 목록을 하니씩 꺼내는 방식으로 사용하기 위함이다.
