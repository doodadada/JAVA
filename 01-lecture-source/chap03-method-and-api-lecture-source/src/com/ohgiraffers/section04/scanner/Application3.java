...
public class Application3 {
    public static void main(String[] args) {
        /* 수업목표. 스캐너 사용시 주의사항에 대해 이해하고 사용시 주의사항을 고려하여사용할 수 있다. */
        ...
        * */
        ...
        sc.nextLine(); //일종의 clear의 개념, 한 줄을 비워준다.
        String str2 = sc.nextLine(); //<< string저장시 next()가아닌 nextLine을 하게 되면 공백을 한 토큰으로 받아 마지막 input을 못받는 상황이 발생
