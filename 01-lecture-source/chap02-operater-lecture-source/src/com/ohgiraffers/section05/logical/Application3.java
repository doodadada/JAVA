...
public class Application3 {
    public static void main(String[] args){
        ...
        * */
        ...
        int result = (false && ++num1 > 0)? num1 : num1; //&&앞이false라 뒤에 ++num1을 실행하지 않음, num1==10

        System.out.println("&&실행 확인 : "+ result);

        /*  2. 논리식 || 논리식 : 앞에 결과가 true면 뒤를 실행 안함*/
        /*
        *   조건식 둘 중 하나라도 true를 반환하면 true를 반환하기 때문에 앞에 미리 true가 나오게 되면
        *   뒤에 조건을 확인할 필요없이 true를 반환한다
        *   따라서 연산 횟수를 줄이기 위해서는 || 연산의 경우, 앞에 true가 나올 가능성이 높은 조건을 작성하는 것이 좋다.
        * */
