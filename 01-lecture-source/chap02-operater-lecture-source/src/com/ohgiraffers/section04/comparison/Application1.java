...
public class Application1 {
    public static void main(String[] args){
        ...
        *   연산자 중 참 혹은 거짓을 변환하는 연산자는 삼항연산자의 조건식이나 조건문의 조건절에 많이 사용된다.
        *   (충분히 연습이 필요함!)
        * */
        ...
        * */
        ...
        System.out.println("dnum1이 dnum2보다 큰거나 같은지 비교 " + (inum1>=dnum2));
        ...
        // System.out.println("bool1가 bool2보다 큰지 비교 : " + (bool1 > bool2)); 에러발생
        // System.out.println("bool1가 bool2보다 크거나 같은지 비교 : " + (bool1 >= bool2)); 에러발생
        // System.out.println("bool1가 bool2보다 작은지 비교 : " + (bool1 < bool2)); 에러발생
        // System.out.println("bool1가 bool2보다 작거나 같은지 비교 : " + (bool1 <= bool2)); 에러발생
        ...
        // System.out.println("str1과 str2가 큰지 비교 "+(str1 > str2)); 크기비교 불가. 에러발생
