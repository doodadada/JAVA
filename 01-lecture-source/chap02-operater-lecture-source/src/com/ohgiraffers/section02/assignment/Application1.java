...
public class Application1 {
    public static void main(String[]args){
        ...
        *   '-=' : 왼쪽에 피연산자에 오른쪽의 피연산자를 뺀 결과를 왼쪽에 피연산자에 대입함
        *   '*=' : 왼쪽에 피연산자에 오른쪽의 피연산자를 곱한 결과를 왼쪽에 피연산자에 대입함
        *   '/=' : 왼쪽에 피연산자에 오른쪽의 피연산자를 나눈 결과를 왼쪽에 피연산자에 대입함
        *   '%=' : 왼쪽에 피연산자에 오른쪽의 피연산자를 나눈 나머지 결과를 왼쪽에 피연산자에 대입함
        * */
        ...
        num += 3; //num=num+3과 같은 의미이다.
        System.out.println("num : " + num);

        num -=5; //num=num-5와 같은 의미이다.
        System.out.println("num : " + num);

        num *=2; //num=num*2와 같은 의미이다.
        System.out.println("num : " + num);

        num /= 2; //num=num/2와 같은 의미이다.
        System.out.println("num : " + num);

        num %= 3; //num=num%3와 같은 의미이다.
        System.out.println("num : " + num);
