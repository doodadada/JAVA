...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("ch2 = " + ch2); //16진수 주소값

        /*
        *  hashcode() : 일반적으로 객체의 주소값을 10진수로 변환하여 생성된 객체의 고유한 정수값을 반환한다.
        *  동일객체인지 비교할 때사용할 목적으로 쓰이며 동등 객체를 동일 객체 취급하이 위해 오버라이딩해서 사용한다.
        * */

        System.out.println("arr2 = " + arr2.hashCode()); //16진수 주소값
        System.out.println("ch2 = " + ch2.hashCode()); //16진수 주소값

        System.out.println("arr2의 길이 : " + arr2.length);
        System.out.println("ch2의 길이 : " + ch2.length);
