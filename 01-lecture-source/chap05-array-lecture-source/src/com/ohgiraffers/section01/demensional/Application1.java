package com.ohgiraffers.section01.demensional;
...
public class Application1 {
    public static void main(String[] args) {
        ...
        // iarr = new int[][]; //크기를 지정하지 않으면 에러발생입니다.
        // iarr = new int[][5]; //주소를 묶어서 관리할 배열의 크기를 지정하지 않으면 에러발생입니다.
        iarr = new int[3][]; //이건 에러 괜찮

        /* 3. 주소를 관리하는 배열의 인덱스마다 배열을 할당한다. */
        iarr[0] = new int[5];
        iarr[1] = new int[5];
        iarr[2] = new int[5];
        //iarr[3] = new int[5]; 에러발생
