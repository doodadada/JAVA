...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 2. 명시적 초기화 된 내용 확인 */
        System.out.println("명시적 초기화 product.getInformation() = " + product.getInformation());

        /* 3. 초기화 블럭으로 필드 초기화 확인 */
        System.out.println("인스턴스 초기화 블럭 product.getInformation() = " + product.getInformation());
        /* 4. stattic 초기화 블럭으로 필드 초기화 확인 */
        System.out.println("정적 초기화 블럭 product.getInformation() = " + product.getInformation());
        /* 5. 매개변수 있는 생성자를 이용한 초기화 확인*/
