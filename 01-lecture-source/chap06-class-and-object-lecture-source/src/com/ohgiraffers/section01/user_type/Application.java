...
public class Application {
    public static void main(String[] args) {
         ...
         *  2. 모든 회원 정보를 인자로 메소드 호출시 값을 전달해야하면 너무 많은 값들을 인자로
         *  전달해야해서 한 눈에 안 들어온다.
        ...
        /* 사용자 정의의 자료형 사용하기*/
        /* 2-1. 변수 선언 및 객체 생성*/
        /* 자료형 변수명 = new 클래스명(); <지금까지 사용한 구문은 객체(인스턴스) 생성 구문
         ...
         *  '.' 참조연산자라고 하는데 레퍼런스 변수가 참고하고 있느 주소로 접근한다는 의미를 가진다.
         *  각 공간은 필드명으로 접근한다.(배열은 인덱스로 접근, 객체는 필드명으로 접근)
         * */
        System.out.println("=======member 클래스 호출 후 필드변수들 출력========");
        ...
        System.out.println("=======필드변수들 값 변경 후 출력========");
