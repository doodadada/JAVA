    ...
    * */
    ...
    public void testMethod(int num){ //메소드 영역의 시작
        ...
        * */
        ...
        // System.out.println("localNum = " + localNum); //에러발생 //초기화가 안되어 있어 에러발생
        System.out.println("globalNum = " + globalNum); //다른곳에서 값을 넣었기 때문에 초기화 필요없음
    ...
    public static void testMethod3(){
        ...
        // System.out.println("globalNum = " + globalNum); //Non-static field 'globalNum' cannot be referenced from a static context
    }
}
