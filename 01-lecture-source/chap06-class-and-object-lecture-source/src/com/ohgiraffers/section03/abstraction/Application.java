...
public class Application {
    public static void main(String[] args) {
         ...
         *  현실세계를 프로그램의 목적에 맞게 단순화하려는 추상화라는 기법을 적용하게 된다.
         * */

        /*
         *  추상화란?
         *  공통된 부분을 추출하고 공통되지 않은 부분을 제거한다는 의미를 가지며,
         *  추상화의 목적은 유연성을 확보하기 위함이다. 유연성 확보는 여러곳에 적용할 수 있는 유일한 객체를 의미하며,
         *  즉, 재사용성이 높아질 수 있다는 의미이다. 객체의 재사용성이 증가하면 중복 작성되는 코드를 줄일 수 있으며,
