...
public class Application {
    public static void main(String[] args) {
        ...
        *  다형성이 적용되어 동적바인딩에 의해 다양한 응답을 할 수 있다.
        * */
        ...
        *
        * */
        // Product product = new Product(); //에러발생 추상클래스는 인스턴스 생성불가
        SmartPhone smp = new SmartPhone();
        System.out.println(smp instanceof SmartPhone);
        System.out.println(smp instanceof Product);
        System.out.println(smp instanceof Object);

        Product product = new SmartPhone(); //다형성 적용(묵시적 up-casting)

        product.absMethod();

        product.NonStaticMethod();
        product.staticMethod(); //되긴 하는데 권장하지는않음
        ...
        *  따라서 여러 클래스들을 그룹화 하여
        *  필수 기능을 정의하여 강제성을 부여해 개발시 일관된 인터페이스를 제공
        * */
