...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        InterProduct interProduct = new Proudct();

        interProduct.nonStaticMethod(); //동적바인딩 발생
        interProduct.absMethod();

        // overriding를 안하면 인터페이스의 default 메소드를 호출됨...
        // interProduct.defaultMethod(); //?

        InterProduct.staticMethod(); //인터페이스로부터 직접호출도 가능

        System.out.println(InterProduct.MAX_NUM); //인터페이스로부터 직접호출가능
