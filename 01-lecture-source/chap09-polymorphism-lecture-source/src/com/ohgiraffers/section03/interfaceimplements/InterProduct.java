...
public interface InterProduct extends java.io.Serializable/*, java.util.Comparator*/ {//다중상속 됨
    /*
    ...
    int MIN_NUM = 10; //묵시적으로 앞에 public sattic final가 있다.

    /* 인터페이스는 생성자를 받을 수 없다*/
    // public void interProduct(){} //에러발생

    /* 인터페이스가 구현부가 있는 non-static 메소드를 가질 수 없다. */
