...
public class Calculator {
    ...
    public void checkMethod(){
        System.out.println("Calculator class에서 checkMethod 함수가 실행되었습니다.");
    }
    ...
    public int minusTowNumber(int a, int b){

        return a-b;
    }
    public int multiTowNumber(int a, int b){

        return a*b;
    }
    public int divideTowNumber(int a, int b){
